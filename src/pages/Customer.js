          ...
          >
            ...
            {/* <div>
              <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                <img
                  className="uk-position-bottom-right"
                  src="assets/img/in-testimoni-2.png"
                  alt="client-testimoni"
                  width={200}
                />
                <div className="uk-card-header">
                ...
                <div className="uk-card-footer">
                  <img
                    src="assets/img/in-client-testi-1.svg"
                    alt="client-logo"
                    width={54}
                  />
                  <blockquote>
                    <footer>
                      Gabrielle Barger
                      <br />
                      <cite>Help Desk at pushbullet</cite>
                    </footer>
                  </blockquote>
                </div>
              </div>
            ...
            <div>
              <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                <img
                  className="uk-position-bottom-right"
                  src="assets/img/in-testimoni-3.png"
                  alt="client-testimoni"
                  width={200}
                />
                <div className="uk-card-header">
                ...
                <div className="uk-card-footer">
                  <img
                    src="assets/img/in-client-testi-2.svg"
                    alt="client-logo"
                    width={54}
                  />
                  <blockquote>
                    <footer>
                      Melvin Cortez
                      <br />
                      <cite>Cloud Architect at stormpath</cite>
                    </footer>
                  </blockquote>
                </div>
              </div>
          ...
          >
            ...
            {/* <div>
              <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                <div className="uk-card-header">
                  <img
                    src="assets/img/in-client-testi-3.svg"
                    alt="client-logo"
                    width={60}
                  />
                </div>
            ...
            <div>
              <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                <div className="uk-card-header">
                  <img
                    src="assets/img/in-client-testi-4.svg"
                    alt="client-logo"
                    width={60}
                  />
                </div>
                ...
                <div className="uk-card-footer">
                  <blockquote>
                    <footer>
                      Melvin Cortez
                      <br />
                      <cite>Cloud Architect at blossom</cite>
                    </footer>
                  </blockquote>
                </div>
              </div>
            ...
            <div>
              <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                <div className="uk-card-header">
                  <img
                    src="assets/img/in-client-testi-5.svg"
                    alt="client-logo"
                    width={60}
                  />
                </div>
                <div className="uk-card-body">
                  <blockquote>
                    <p>
                      Has been a great tool for me on monthly updates &amp;
                      helps to communicate the issues with us.
                    </p>
                  </blockquote>
                </div>
                <div className="uk-card-footer">
                  <blockquote>
                    <footer>
                      Franklin Clark
                      <br />
                      <cite>Sales Analyst at mailgun</cite>
                    </footer>
                  </blockquote>
                </div>
              </div>
