    ...
    return (
      ...
      <div className="uk-section">
          <div className="uk-container">
              <div className="uk-grid-match uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m in-card-10" data-uk-grid>
          ...
          <div className="uk-container">
              <div className="uk-grid">
                  <div className="uk-width-2-3@m">
                      <div className="uk-grid uk-grid-small" data-uk-grid>
                          ...
                          <div className="uk-width-expand">
                              ...
                              <div className="uk-grid uk-child-width-1-2@s uk-child-width-1-2@m in-margin-bottom-30@s" data-uk-grid>
                                  <div>
                  ...
                  <div className="uk-width-1-3@m">
                      ...
                      <p className="uk-text-small"><a href="/#">See Full Shares Table</a></p>
                  </div>
              </div>
          </div>
      </div>
