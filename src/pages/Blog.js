                ...
                {/* <div className="uk-width-1-1">
                  <article className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div className="uk-card-media-top">
                      <img src="assets/img/in-blog-image-10.jpg" alt="sample" />
                    </div>
                    <div className="uk-card-body">
                      <h3>
                        <a href="blog-article.html">
                          Here’s what is driving GM’s reported plans to develop
                ...
                {/* <div>
                  <article className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div className="uk-card-body">
                      <h3>
                        <a href="blog-article.html">
                          Sony buys $400m stake in China’s Bilibili
                        </a>
                      </h3>
                      <p>
                ...
                <div>
                  <article className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div className="uk-card-body">
                      <h3>
                        <a href="blog-article.html">
                          Grab names new chief financial officer
                        </a>
                      </h3>
                      <p>
                ...
                <div>
                  <article className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div className="uk-card-body">
                      <h3>
                        <a href="blog-article.html">
                          Monaco launches now tourism campaign
                        </a>
                      </h3>
                      <p>
                        With more than three billion people around the world
                        under lockdown ...
                      </p>
                      <div className="uk-flex uk-flex-middle">
                        <div className="uk-margin-small-right">
              ...
              <aside className="uk-margin-medium-bottom">
                <div className="uk-card uk-card-default uk-card-body uk-border-rounded">
                  ...
                  <div className="uk-margin-top in-widget-tag">
                    ...
                    {/* <a href="/#">
                      <span className="uk-label uk-border-pill">Asia</span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">Business</span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">Startups</span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">
                        Automotive
                      </span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">Travels</span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">Marketing</span>
                    </a>
                    <a href="/#">
                      <span className="uk-label uk-border-pill">
                        Technology
                    ...
                    <a href="/#">
                      <span className="uk-label uk-border-pill">Politics</span>
                    </a> */}
                  </div>
                </div>
              </aside>
