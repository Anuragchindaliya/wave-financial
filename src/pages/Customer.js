function Customers() {
    ...
    return (
              ...
              <div className="uk-width-3-4@m">
                <div data-uk-grid>
                  <div className="uk-width-1-2@s uk-width-2-3@m">
                    <p className="uk-text-large">We help our customers engage investors so their companies can grow</p>
                      ...
                      <li>
                        <div className="uk-flex uk-flex-middle">
                          ...
                          <div>
                            ...
                            <span className="uk-label uk-text-small uk-border-rounded">Business launch</span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div className="uk-flex uk-flex-middle">
                          ...
                          <div>
                            ...
                            <span className="uk-label uk-text-small uk-border-rounded">Investor engaged</span>
                          </div>
                        </div>
                      </li>
                    </ul>
        ...
        <div className="uk-section in-offset-top-20">
          <div className="uk-container">
            <div className="uk-grid-medium uk-child-width-1-2@m in-testimonial-8" data-uk-grid>
              <div>
                <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                  <img className="uk-position-bottom-right" src="assets/img/in-testimoni-2.png" alt="client-testimoni" width={200} />
                  ...
                  <div className="uk-card-footer">
                    <img src="assets/img/in-client-testi-1.svg" alt="client-logo" width={54} />
                    <blockquote>
              ...
              <div>
                <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                  <img className="uk-position-bottom-right" src="assets/img/in-testimoni-3.png" alt="client-testimoni" width={200} />
                  <div className="uk-card-header">
                    <blockquote>
                  ...
                  <div className="uk-card-footer">
                    <img src="assets/img/in-client-testi-2.svg" alt="client-logo" width={54} />
                    <blockquote>
        ...
        <div className="uk-section in-offset-top-50">
          <div className="uk-container">
            <div className="uk-grid-medium uk-child-width-1-3@m in-testimonial-7" data-uk-grid>
              <div>
                <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                  <div className="uk-card-header">
                    <img src="assets/img/in-client-testi-3.svg" alt="client-logo" width={60} />
                  </div>
              ...
              <div>
                <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                  <div className="uk-card-header">
                    <img src="assets/img/in-client-testi-4.svg" alt="client-logo" width={60} />
                  </div>
                  <div className="uk-card-body">
                    <blockquote>
              ...
              <div>
                <div className="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                  <div className="uk-card-header">
                    <img src="assets/img/in-client-testi-5.svg" alt="client-logo" width={60} />
                  </div>
                  <div className="uk-card-body">
                    <blockquote>
