import features from "database/home2/features.json";
import blog from "database/home2/blog.json";
const Homepage2 = () => {
  return (
    <main>
      ...
      <div className="uk-section uk-padding-large in-offset-bottom-70 in-wave-6">
        <div className="uk-container">
          <div className="uk-grid-collapse uk-position-relative" data-uk-grid>
            <div className="uk-position-bottom-right">
              <img
                src="assets/img/in-wave-background-2.png"
                alt="wave-hq"
                width={540}
                height={513}
              />
            ...
            <div className="uk-width-1-1">
              <h1>
                ...
                <span className="in-highlight">480,000</span> traders
              </h1>
            </div>
            <div className="uk-width-3-5@m">
              <div
                      ...
                      <div className="uk-card uk-card-default uk-card-body uk-border-rounded">
                        <div className="uk-flex uk-flex-middle">
                          <div className="uk-margin-small-right">
                            <i
                              className={`${feature.icon} fa-2x in-icon-wrap small transparent`}
                            />
                          </div>
                          <div>
                        ...
                        <p className="uk-margin-small-top">{feature.desc}</p>
                      </div>
                    </div>
                  );
                })}
      ...
      {/* section content begin */}
      <div
        className="uk-section uk-section-muted uk-padding-large uk-background-cover uk-background-center-center"
        style={{ backgroundImage: "url(img/in-wave-background-3.jpg)" }}
      >
        <div className="uk-container in-wave-7">
          <div className="uk-grid uk-flex uk-flex-center">
            <div className="uk-width-3-4@m">
              <h4 className="uk-text-primary uk-margin-remove-bottom">
                Trade with confidence
              </h4>
              <h1 className="uk-margin-small-top uk-margin-remove-bottom">
                New level of <span className="in-highlight">security</span>
              </h1>
              <div
                className="uk-grid-divider uk-child-width-1-2@s uk-child-width-1-2@m uk-margin-medium-top"
                data-uk-grid
              >
                <div>
                  <img
                ...
                <div>
                  <img
                    ...
                    width={64}
                  />
                  <h3 className="uk-margin-small-top">Depth of protection</h3>
                  <p>
                    Temporibus autem quibusdam et aut officiis debitis aut rerum
                    necessitatibus saepe eveniet voluptates repudiandae sint
                    molestiae non recusandae.
      ...
      <div className="uk-section uk-padding-large">
        <div className="uk-container in-wave-8">
          <div className="uk-grid uk-flex uk-flex-center">
            <div className="uk-width-3-5@m uk-text-center">
              <h1 className="uk-margin-remove">
                Up to the minute <span className="in-highlight">analysis</span>
              </h1>
              <p className="uk-text-muted uk-margin-small-top uk-margin-medium-bottom">
                  ...
                  <table className="uk-table uk-table-divider uk-text-small">
                    <thead>
                      <tr>
                        ...
                        <th className="uk-text-center">Offer</th>
                        <th className="uk-text-right uk-visible@s">Change</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td className="uk-text-center">
                          <span className="uk-label uk-label-success">
                            6261.0
                            <i className="fas fa-caret-up fa-xs uk-margin-small-left" />
                          </span>
                        </td>
                        <td className="uk-text-center">
                          <span className="uk-label uk-label-success">
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">17.7</span>
                        </td>
                      </tr>
                      <tr>
                        <td>Germany 30</td>
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">14.1</span>
                        </td>
                      </tr>
                      <tr>
                        <td>Wall Street</td>
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">19.5</span>
                        </td>
                      </tr>
                      <tr>
                        <td>Bitcoin (USD)</td>
                        <td className="uk-text-center">
                          <span className="uk-label uk-label-danger">
                            9419.00
                            <i className="fas fa-caret-down fa-xs uk-margin-small-left" />
                          </span>
                        </td>
                        <td className="uk-text-center">
                          <span className="uk-label uk-label-danger">
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-danger">-57.79</span>
                        </td>
                      </tr>
                      <tr>
                        <td>EUR/USD</td>
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">0.00168</span>
                        </td>
                      </tr>
                      <tr>
                        <td>GBP/USD</td>
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">0.00008</span>
                        </td>
                      </tr>
                      <tr>
                        <td>Spot Gold</td>
                        ...
                        <td className="uk-text-right uk-visible@s">
                          <span className="uk-text-success">0.24</span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
      ...
      <div className="uk-section">
        <div className="uk-container in-wave-9">
          <div className="uk-grid uk-flex uk-flex-center">
            <div className="uk-width-3-4@m">
              <div
                className="uk-grid-large uk-child-width-1-2@s uk-child-width-1-2@m uk-flex uk-flex-middle"
                data-uk-grid
              >
                <div>
                  <img
                    src="assets/img/in-wave-mockup-2.png"
                    alt="wave-mockup"
                  />
                </div>
                <div>
                  <h2 className="uk-margin-remove-bottom in-offset-top-50">
                    Metatrader 5
                  </h2>
                  ...
                  <p className="uk-margin-medium-bottom">
                    Lorem ipsum dolor sit amet consectet adipiscing elite, sed
                    do eiusmod tempor incididunt laboremi dolore magna aliqua
      ...
      {/* section content end */}
      {/* section content begin */}
      <div className="uk-section uk-section-primary in-offset-bottom-40">
        <div className="uk-container in-wave-10">
          <div className="uk-grid uk-position-relative uk-flex uk-flex-middle">
            <div className="uk-position-bottom-right in-offset-bottom-40">
              <img
                src="assets/img/in-wave-background-4.svg"
                alt="wave-hq"
                width={500}
              />
            </div>
            <div className="uk-width-auto@m uk-text-center">
              <img
                src="assets/img/in-wave-icon-10.svg"
                alt="wave-icon"
                width={96}
              />
            </div>
            <div className="uk-width-3-5@m">
              ...
              <p>
                ...
                quae et quasi architecto.{" "}
                <a
                  className="uk-text-small uk-text-uppercase uk-margin-small-left"
                  href="/#"
                >
                  Learn more
                  <i className="fas fa-long-arrow-alt-right fa-sm uk-margin-small-left" />
                </a>
              </p>
            </div>
          </div>
